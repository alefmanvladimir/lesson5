...
async function Item_init() {
    ...
    initItem_init_args({ $$type: 'Item_init_args' })(builder);
...
export class Item implements Contract {
    ...
    static async init() {
        return await Item_init();
    }
    
    static async fromInit() {
        const init = await Item_init();
